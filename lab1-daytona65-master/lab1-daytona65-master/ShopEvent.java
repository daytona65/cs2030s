  ...
  public Event[] simulate() {
    if (this.eventType == ShopTypes.ARRIVAL) {
      ...
      if (counter == -1) {
        ...
        // should depart.
        return new Event[] { 
          new ShopEvent(ShopTypes.DEPARTURE, this.getTime(), this.customerId)
        };
      } else {
