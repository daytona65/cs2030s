...
class Lab5 {
  public static String getGrade(String student, String module, String assessment,
    ...
    Transformer<Map<String, Map<String, String>>, Maybe<Map<String, String>>> getModule = std -> {
      return Maybe.<Map<String, String>>of(std.get(module));
    };

    Transformer<Map<String, String>, Maybe<String>> getAssessment = mod -> {
      return Maybe.<String>of(mod.get(assessment));
    };
